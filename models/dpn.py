...
and another PyTorch implementation https://github.com/oyam/pytorch-DPNs.
...
from data_conversion import IMAGENET_DPN_MEAN, IMAGENET_DPN_STD
...
class DPN(nn.Module):
    ...
    def forward(self, x):
        ...
        return pooled_view.view(pooled_view.size(0), -1)
