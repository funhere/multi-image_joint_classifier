...
This [Docker image](https://github.com/simon_feng/web-usuke-classifier/blob/master/Dockerfile) contains Python 3, Flask and fastai.
```
docker build -t app .
...
- Our Flask web app is available here:  [**usuke-img-classifier.herokuapp.com**](https://usuke-img-classifier.herokuapp.com)
